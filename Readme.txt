...
Data/Eyetracking/AOI List.xlsx: This is an Excel file where we have manually inputed borders (in pixels) for each Area of Interest for each question. The AOI Documentation folder includes screenshots of each question and its AOIs, for reference.
