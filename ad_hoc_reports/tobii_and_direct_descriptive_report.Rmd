---
title: "Tobii and Direct Indicators Descriptive Report v2"
...
lm(data = df,
   direct ~ tobii.avgQTextFixationTime + readingLevelMean)%>%
  report_regression()

lm(data = df,
   direct ~ tobii.avgQTextFixationTime + readingLevelMean + (tobii.avgQTextFixationTime * readingLevelMean))%>%
  report_regression()
```
