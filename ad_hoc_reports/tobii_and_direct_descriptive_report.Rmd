---
title: "Tobii and Direct Indicators Descriptive Report_v1"
date: "`r format(Sys.time(), '%B %d, %Y')`"
output: pdf_document
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_file = file.path(dirname(inputFile), 'Tobii and Direct Indicators Descriptive Report_v1.pdf')) })
---
